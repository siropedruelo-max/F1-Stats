...
function crearTarjetaFavorito(piloto) {
  ...
  tarjeta.className = 'tarjeta-piloto';
  ...
  numero.className = 'numero-piloto';
  numero.textContent = `#${piloto.driver_number}`;

  const botonEliminar = document.createElement('button');
  botonEliminar.className = 'boton-favorito boton-eliminar-favorito';
...
function crearEstadisticas(piloto) {
  ...
  estadisticas.className = 'contenedor-estadisticas';

  estadisticas.appendChild(crearItemEstadistica(piloto.points, 'Ptos', 'estadistica-puntos'));
  estadisticas.appendChild(crearItemEstadistica(piloto.wins, 'Victorias', 'estadistica-victorias'));
  estadisticas.appendChild(crearItemEstadistica(piloto.podiums, 'Podios', 'estadistica-podios'));
